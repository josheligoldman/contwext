    ...
    for (let i = 0; i < data.length; i++) {
        ...
        article_div.innerHTML = `
            <a href="${web_url}" target="_blank" rel="noopener noreferrer">
                ...
                <div class="article-headline" style="font-size: ${width/32}px !important;
...
function addContwextAction() {
    ...
    for (let i = 0; i < tweets.length; i++) {
        ...
        let like_button = tweet.querySelector('div[data-testid="like"], div[data-testid="unlike"]').parentNode;
...
setInterval(addContwextAction, 1000);
